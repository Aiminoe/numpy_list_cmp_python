...
if __name__ == '__main__':
    ...
    lista = [rdm.randint(1,10) for x in range(3)]
    print('Sus Cartas: ', lista)
    resultado =sum(lista)
    if resultado <= 21:
        print("Tus cartas {}, suman {}.".format(lista,resultado))
    else:
        if resultado > 21:
            print("Tus cartas {}, suman {}. Perdiste!!".format(lista,resultado))
